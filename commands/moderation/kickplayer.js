...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({ embeds: [kickEmbed] });
        logToLogChannel(interaction.client, interaction.guild.id, serverName, "Kicked Player", `Kicked Player with the Steam Id ${playerSteamId} from the server ${serverName}`);
    },
